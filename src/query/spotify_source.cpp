...
spotify_source::spotify_source() : music_source(S_SOURCE_SPOTIFY, T_SOURCE_SPOTIFY, new spotify)
{
	build_credentials();
	m_capabilities = CAP_TITLE | CAP_ARTIST | CAP_ALBUM | CAP_RELEASE | CAP_COVER | CAP_DURATION | CAP_NEXT_SONG |
					 CAP_PREV_SONG | CAP_PLAY_PAUSE | CAP_VOLUME_MUTE | CAP_PREV_SONG | CAP_STATUS;
}
