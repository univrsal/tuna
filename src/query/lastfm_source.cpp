...
lastfm_source::lastfm_source() : music_source(S_SOURCE_LAST_FM, T_SOURCE_LASTFM, new lastfm)
{
...
void lastfm_source::refresh()
{
	...
	begin_refresh();
	m_current.clear();
	QString track_request = "https://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user=" + m_username +
							"&api_key=" + m_api_key + "&limit=1&format=json";
