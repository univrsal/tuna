...
bool song::operator==(const song &other) const
{
	...
	return state() == other.state() && data() == other.data() && cover() == other.cover() && label() == other.label() &&
		   get_int_value('d') == other.get_int_value('d') && get_int_value('a') == other.get_int_value('a') &&
		   get_int_value('l') == other.get_int_value('l') && get_string_value('t') == other.get_string_value('t') &&
		   get_string_value('a') == other.get_string_value('a') &&
		   get_string_value('y') == other.get_string_value('y') &&
		   get_string_value('b') == other.get_string_value('b') && get_string_value('r') == other.get_string_value('r');
}
